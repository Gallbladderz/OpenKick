...
val appModule = module {
    ...
    single { com.gallbladderz.openkick.features.player.ClipRepository(get()) }
    ...
    single { ChatRepository(get(), CoroutineScope(SupervisorJob() + Dispatchers.IO)) }
    ...
    viewModel { (videoId: String) ->
        com.gallbladderz.openkick.features.player.vod.VodPlayerViewModel(
            videoId = videoId,
            playerManager = get(),
            repository = get()
        )
